...
public class MetalRusService {
    ...
    public HashMap<String, Object> cycleMetalRus(Integer quantity, SetPositions set) {
        ...
        try {
            if (stockMetalRusRepository.getStockQuantity(set.getRecipeId()) < quantity*set.getQuantity()) {
                ...
                response.put("current", stockMetalRusRepository.getStockQuantity(set.getRecipeId()));
