...
public class PlasmaService {
    ...
    public HashMap<String, String> cyclePlasma(Integer quantity, SetPositions set) {
        HashMap<String, String> response = new HashMap<>();
        try {
            if (stockPlasmaRepository.getStockQuantity(set.getRecipeId()) < quantity*set.getQuantity()) {
                response.put("name", set.getName());
                response.put("current", stockPlasmaRepository.getStockQuantity(set.getRecipeId()).toString());
