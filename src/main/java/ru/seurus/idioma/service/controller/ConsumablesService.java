...
public class ConsumablesService {
    ...
    public HashMap<String, Object> cycleConsumables(Integer quantity, SetPositions set) {
        ...
        try {
            if (stockConsumablesRepository.getStockQuantity(set.getRecipeId()) < quantity*set.getQuantity()) {
                ...
                response.put("current", stockConsumablesRepository.getStockQuantity(set.getRecipeId()));
